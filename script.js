    ...
    $dni.addEventListener('blur', function() {
        switch (true) {
            ...
            case !regExDNI.test($dni.value):
                $dniErrors.innerHTML = 'Ingrese un DNI válido'
                $dni.classList.add('is-invalid')
                break;
            default:
    ...
    $email.addEventListener('blur', function() {
        switch (true) {
            case !$email.value.trim():
                $emailErrors.innerHTML = 'El E-mail es obligatorio'
    ...
    $pass.addEventListener('blur', function() {
        switch (true) {
            case !$pass.value.trim():
                $passErrors.innerHTML = 'El contraseña es obligatoria'
                $pass.classList.add('is-invalid')
                break;
            case !regExPass.test($pass.value):
                $passErrors.innerHTML = 'La contraseña debe tener: entre 6 o 12 caracteres, una mayúscula, una minúscula y un número';
                $pass.classList.add('is-invalid')
                break;
            default:
            ...
            if (!allowefExtensions.exec(filePath)) {
                ...
                if ($file.files && $file.files[0]) {
                    ...
                    reader.onload = function(e) {
                        $imgPreview.innerHTML = '<img src="' + e.target.result + '" class="imgReal"/>';
                    };
